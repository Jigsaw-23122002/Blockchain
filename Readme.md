...
Suppose miners individually try to mine the block but among them suppose there are some bulk miners, then in such cases the individual miners will suffer as their chance of mining the block individually is very less.
...
That the higher percentge of the reward will be given to the miner providing higher power technology for mining the block.
